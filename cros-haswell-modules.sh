...
# preserve old as .orig
sudo mv /lib/modules/$mykern/kernel/drivers/input/touchscreen/atmel_mxt_ts.ko.gz /lib/modules/$mykern/kernel/drivers/input/touchscreen/atmel_mxt_ts.ko.gz.orig
